...
export default function ProductDetials() {
  ...
  return (
    <>
    <div className="pt-3">
      <h2 className="fw-bold">About this item</h2>{" "}
      ...
      <div className="overflow-hidden">
        ...
        <Collapse in={openDetails}>
          <div id="h-96 example-collapse-text">
            <p className=" fw-semibold my-2 fs-5">
              Creating distinctive stories with DSLR quality photos and Full HD
              movies is easier than you think with the 18 Megapixel Canon EOS
              Rebel T100. Share instantly and shoot remotely via your compatible
              smartphone with Wi-Fi and the Canon Camera Connect app. The
              powerful 18 Megapixel sensor has up to 19 times more surface area
              than many smartphones, and you can instantly transfer photos and
              movies to your smart device. The Canon EOS Rebel T100 has a Scene
              Intelligent Auto feature that allows you to simply frame and shoot
              for great results. It also features Guided Live View shooting with
              Creative Auto mode, and you can add unique finishes with Creative
              Filters. The Canon EOS Rebel T100 makes it fast and easy to share
      ...
      <div>
        <div className="row py-2">
          ...
          tabindex="0"
        >
          <h4 id="scrollspyHeading1">EOS Rebel T100</h4>
          <div className="pt-3">
            <img
              className="boxStyle"
              ...
              alt=""
            />
            <h2 id="scrollspyHeading2" className="fw-bold">
              Your Creative Journey Starts Here Exclusively at Walmart.
            </h2>
            <p>
              Creating unique stories with DSLR-quality photos and movies is fun
              and easy thanks to the EOS Rebel T100 entry-level camera.
              Featuring an 18.0 Megapixel CMOS sensor, Full HD video, built-in
              Wi-Fi®* and more, it helps you capture and share images for
              high-quality storytelling that sets you apart.
            </p>
          ...
          <div className="pt-3">
            ...
            <p className="py-3">
              The 18.0 Megapixel CMOS sensor helps you easily capture images
              with stand-out detail and clarity.
            </p>
          </div>
          <div className="pt-3">
            <img
            ...
            <p>
              Bring attention to your subject with the EOS Rebel T100's great
              background blurring capabilities.
            </p>
          </div>
          <div className="pt-3">
            <img
            ...
            <div>
              <h3 className="fw-bold fs-5">For Shooting in Dim Light</h3>
              <p>
                The 6400 maximum ISO and DIGIC Image Processor help capture
          ...
          <div className="pt-3">
            ...
            <div className="">
              ...
              <p>
                The 9-point AF system helps you focus on and capture moving
                subjects so you won’t miss any important
              </p>
            </div>
            <div className="pt-5 row">
              ...
              <div className="pt-2">
                <h5 className="fw-bold fs-5">Easily Frame Your Shots</h5>
                <p>Look through the optical viewfinder to capture with confidence, even in bright, outdoor lighting!</p>
              </div>
              </div>
              </div>
              <div className="col">

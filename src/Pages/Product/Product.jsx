                                ...
                                <div id="h-96 " className="font-sm">
                                  ...
                                  <div className=" flex gap-x-2 my-2 h-12 items-start ">
                                    ...
                                    <div>
                                      ...
                                      provide what you see here, and we have not
                                      verified it.&nbsp;&nbsp;
                                      <button
                                        type="button"
                                ...
                                <div id="example-collapse-text">
                                  ...
                                  >
                                    ...
                                    <div className="pt-3">
                                      ...
                                      <p className="py-2">
                                        Creating unique stories with
                                        DSLR-quality photos and movies is fun
                                        and easy thanks to the EOS Rebel T100
                                        entry-level camera. Featuring an 18.0
                                        Megapixel CMOS sensor, Full HD video,
                                        built-in Wi-Fi®* and more, it helps you
                                        capture and share images for
                                        high-quality storytelling that sets you
                                        apart.
                                      </p>
                                    ...
                                    <div className="pt-3">
                                      ...
                                      <p className="py-3">
                                        ...
                                        easily capture images with stand-out
                                        detail and clarity.
                                      </p>
                                    </div>
                                    <div className="pt-3">
                                      ...
                                      <p>
                                        Bring attention to your subject with the
                                        EOS Rebel T100's great background
                                    ...
                                    <div className="pt-3">
                                      ...
                                      <div>
                                        ...
                                        <p>
                                          ...
                                          Processor help capture clear images,
                                          even in low light!
                                        </p>
                                      </div>
                                    </div>
                                    <div className="pt-3">
                                      ...
                                      <div className="">
                                        ...
                                        <p>
                                          The 9-point AF system helps you focus
                                          on and capture moving subjects so you
                                          won’t miss any important
                                        </p>
                                      </div>
                                      <p className="py-6 ">
                                          ...
                                          <div>
                                            ...
                                            <div className="">
                                              ...
                                              <p className=" ">
                                                ...
                                                viewfinder to capture with
                                                confidence, even in bright,
                                                outdoor lighting!
                                              </p>
                                            </div>
                                          </div>
                                      ...
                                      return (
                                        <div className="">
                                          ...
                                          >
                                            ...
                                            <h2 className="flex pt-2 font-bold">
                                              {review.text}
                                            </h2>
                                          </Card>
                                        </div>

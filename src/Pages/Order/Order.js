...
function Order() {
  ...
  return <>
        ...
        <div className="cart_head mx-10 d-flex gap-4">
              ...
              <Accordion alwaysOpen={true}>
                  <Accordion.Panel>
                      ...
                      <Accordion.Content>
                          <div className="d-flex justify-between gap-4 ">
                              <div className="w-1/3 py-3 cursor-pointer border-2 rounded-lg d-flex flex-col justify-center items-center">
                ...
                <div className="max-w-xlg bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 mb-3">
                    ...
                    <div className="p-3 ">
                        ...
                        <div className="d-flex justify-between gap-5">
                            <div className="d-flex gap-3 items-center p-2 w-1/2">
                            ...
                            <div className="d-flex flex-col justify-between w-1/2">
                                ...
                                <div className="d-flex justify-between">
                                    ...
                                    <div className="d-flex items-center border rounded-full gap-3 px-3 py-1">
                                        <AiOutlineMinus/>
                                        <p>1</p>
                                        <AiOutlinePlus/>
                                    </div>
                ...
                <div className="max-w-xlg bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 mb-14 p-3">
                    ...
                    <div className="d-flex gap-2 items-end">
                        <div className="w-1/5">
                            <div className="d-flex flex-col relative mb-4 ">
                                ...
                                <div className="d-flex items-center text-white bg-blue-600 w-fit absolute bottom-0 left-0 rounded-full p-1 text-lg ">
            ...
            <div className="right_side w-1/3">
                <div className="max-w-xlg bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 p-3">
                    ...
                    <div className="d-flex font-semibold justify-between p-3">
                        <p>Estimated total</p>
                        <span>$20.97</span>
                    </div>
                </div>
        ...
        <div className="footer w-full d-flex mb-3 justify-around">

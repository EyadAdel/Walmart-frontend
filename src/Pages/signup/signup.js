        ...
        {({
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="mb-3 fName">
              <label htmlFor="firstName" className="text-sm font-semibold mb-3">
                First name
              </label>
            ...
            <div className="mb-3 lName">
              <label htmlFor="lastName" className="text-sm font-semibold mb-3">
                Last name
              </label>
              <div className="flex mt-2">
                <input
                  ...
                  className={`grow outline outline-offset-1 outline-1 outline-gray-300 focus:ring  bg-transparent outline-0 focus:ring-indigo-200 focus:ring-opacity-50 rounded-sm shadow-sm p-3 ${
                    errors.lastName && touched.lastName ? "outline-red-500" : ""
                  }`}
                  id="lastName"
            ...
            <div className="mb-2">
              <Field
                ...
                type="checkbox"
              />
              <label htmlFor="sendEmails" className="text-sm text-slate-400">
